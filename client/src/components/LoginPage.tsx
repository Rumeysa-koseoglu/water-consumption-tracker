...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col p-4 md:p-10">
      <div className="flex flex-col h-50 w-full items-center">
        <p
          className=" md:flex text-5xl lg:text-6xl text-center text-[#9ec8fb]
      mt-8 font-bold font-bungee word-spacing-sm md:word-spacing"
        >
          WELCOME TO WA
          <span className=" text-6xl lg:text-7xl text-[#13325b]">T</span>RACK
        </p>
      ...
      >
        <form
          ...
          className="flex flex-col gap-10 h-full lg:h-[70%] w-full max-w-125  justify-center lg:mb-8"
        >
          <p className="w-[85%] h20 md:h-40 mb-20  lg:mb-6 flex items-center justify-center gap-6 text-3xl md:text-4xl text-[#355d8b]">
            <img src={logo} className="size-15 md:size-20" />
            <span className="text-4xl md:text-5xl text-[#9ec8fb] font-outfit ">
              Log In
            </span>
          </p>
          <span className="w-full border border-b-[#223857] border-x-0 border-t-0 py-3 px-2 flex flex-row items-center">
            ...
            <input
              ...
              value={email}
              className="outline-0  w-full placeholder-[#8babd2a5] text-blue-400 text-lg md:text-xl "
